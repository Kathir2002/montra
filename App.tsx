...
//           }),
//         );
//         console.log(isFromPushNotification, 'isFromPushNotification');
...
//           } else {
//             // Handle case where no security method is set
//             setIsLoading(false);
//           }
//         }
//       }
...
//           // setIsFromPushNotification(false);
//         }
//       }, 1000);
//     }
//   };
    ...
    if (pendingNotificationData?.data?.screen) {
      ...
      const attemptNavigation = (retryCount = 0) => {
        if (navigationRef.current?.isReady()) {
          ...
          console.log(
            `Navigation not ready, retrying... (${retryCount + 1}/5)`,
          );
